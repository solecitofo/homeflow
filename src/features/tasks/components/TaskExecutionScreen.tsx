      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <AnimatePresence mode="wait">
          ...
          {execution.phase === 'executing' && (
            ...
            >
              {/* Timer Card */}
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-10 shadow-lg text-center">
                <div className="text-7xl md:text-8xl font-mono font-bold text-primary-500 mb-4">
                  {formatTime(timer.seconds)}
                </div>
                <div className="text-gray-600 text-sm mb-6">tiempo transcurrido</div>
                <div className="flex gap-3 justify-center">
                  {!timer.isRunning ? (
                    <Button variant="primary" onClick={timer.start} size="lg">
                      <Play className="w-5 h-5 mr-2" />
                      Iniciar
                    </Button>
                  ) : (
                    <Button variant="outline" onClick={timer.pause} size="lg">
